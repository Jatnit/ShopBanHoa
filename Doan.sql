...
INSERT INTO ChiTietDonHang (MaDonHang, TenSanPham, HinhAnh, SoLuong, GiaBan)
VALUES
    (10, N'Hoa baby màu sắc', '1.png', 5, 28.75),
    (10, N'Hoa cúc trắng', '2.png', 3, 330.00),
    (2, N'Hoa hồng đỏ', '12.png', 2, 21.50),
    (2, N'Hoa dại màu tự nhiên', '11.png', 4, 243.00),
    (3, N'Hoa tulip vàng', '8.png', 2, 27.25),
    (3, N'Hoa lan trắng', '7.png', 3, 28.75), 
    (4, N'Hoa dại màu tự nhiên', '11.png', 2, 400.00),
    (4, N'Hoa Hồng Trái Tim', '6.png', 3, 30.00),
    (5, N'Hoa hồng đỏ', '12.png', 1, 290.00),
    (5, N'Hoa dại màu tự nhiên', '11.png', 4, 450.00),
    (6, N'Hoa baby màu sắc', '1.png', 2, 27.25),
    (7, N'Hoa Hồng Trái Tim', '6.png', 4, 330.00),  
    (8, N'Hoa dại màu tự nhiên', '11.png', 3, 21.50);  
